...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`flex justify-between items-center w-full h-20 text-white ${color} sticky top-0 z-1000`}
      >
        ...
        <ul className="hidden md:flex">
          {links.map(({ id, link }) => (
            <li
              key={id}
              className="px-4 cursor-pointer capitalize text-white font-medium hover:scale-105"
            >
